...
func (c MockConfigurationDownloader) DownloadConfiguration() StoreConfiguration {
	...
	//insertMultipleMap["7"] = "REDISExcel"
	...
	//deleteMultipleMap["7"] = "REDISExcel"
