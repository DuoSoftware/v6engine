...
func versionHandler(params martini.Params, w http.ResponseWriter, r *http.Request) {
	...
	versionData := "{\"Name\": \"Objectstore\",\"Version\": \"1.2.8-a\",\"Change Log\":\"Removed Non-Redis incremental id for CloudSQL and ELASTIC. Added concurrent ID service to Elastic!\",\"Author\": {\"Name\": \"Duo Software\",\"URL\": \"http://www.duosoftware.com/\"},\"Repository\": {\"Type\": \"git\",\"URL\": \"https://github.com/DuoSoftware/v6engine/\"},\"System Usage\": {\"CPU\": \" " + cpuUsage + " (percentage)\",\"CPU Cores\": \"" + cpuCount + "\"}}"
