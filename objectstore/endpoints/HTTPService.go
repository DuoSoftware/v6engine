...
func versionHandler(params martini.Params, w http.ResponseWriter, r *http.Request) {
	...
	versionData := "{\"Name\": \"Objectstore\",\"Version\": \"1.2.7-a\",\"Change Log\":\"bool test2!\",\"Author\": {\"Name\": \"Duo Software\",\"URL\": \"http://www.duosoftware.com/\"},\"Repository\": {\"Type\": \"git\",\"URL\": \"https://github.com/DuoSoftware/v6engine/\"},\"System Usage\": {\"CPU\": \" " + cpuUsage + " (percentage)\",\"CPU Cores\": \"" + cpuCount + "\"}}"
