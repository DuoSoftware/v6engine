...
func main() {
	...
	fmt.Println(queryparser.GetDataStoreQuery("SELECT tttt, Id, age from Student s1, game g2 where value = 500 AND kappa not between 50 AND 100 AND kat not in ('asdf', 'wert') order by ppds, ggg desc;", "com.duoworld.com", "test"))
